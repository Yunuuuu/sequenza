   ...
   try:
      ...
      if used_module == "pileup2acgt":
         ...
         with xopen('-', "wb") as fileout:
            out_header = ["chromosome", "position", "base.ref", "depth.normal", "depth.tumor", "depth.ratio", "Af", "Bf", "zygosity.normal", "GC.percent", "good.reads", "AB.normal", "AB.tumor", "sample.strand"]
            p1 = args.reference
            p2 = args.sample
            gc = args.gc
