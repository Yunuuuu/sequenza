...
Memory: Minimum 1GB of RAM.  Recommended >2Gb.
Disk space: ? times the size of total data 

R version
Bioconductor version ? 
Python version and modules 
\section{Getting ready with Sequenza package/Installing R/Setting up Sequenza}
----- download from bitbucket/cbs.dtu.dk
----- how to install it. R CMD INSTALL sequenza_version.tar.gz

----- Copy sequenza utils to some location ? 
----- Setting PATH ? 
...
6. Call CNAs(CNVs ?) and mutations
