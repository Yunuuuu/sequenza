...
@ 
 \caption{Result from the Bayesian inference over the defined range of cellularity and ploidy. Color intensity indicates the log-posterior probability of corresponding cellularity/ploidy values.}
      \label{fig:cpPlot}
\end{figure}
